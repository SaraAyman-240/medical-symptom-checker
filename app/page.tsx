          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                MediCheck offers comprehensive health risk assessments to help you understand your health status and take preventive action
              </p>
            </div>
          ...
          <div className="container">
            <div className="grid gap-8 lg:grid-cols-2 items-center">
                ...
                <div className="bg-secondary rounded-lg p-8 text-white relative overflow-hidden">
                  ...
                  <div className="space-y-4 relative z-10">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm">Get personalized recommendations and care guidance</p>
                    </div>
                  </div>
              ...
              <div className="space-y-6 order-1 lg:order-2">
                <h2 className="text-3xl font-bold text-secondary">Why Choose MediCheck?</h2>
                <p className="text-gray-600">
                  MediCheck combines advanced AI technology with evidence-based medical guidelines to provide you with accurate health risk assessments. Our platform is designed to help you make informed decisions about your health and take preventive action.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-sm">
                MediCheck provides comprehensive health risk assessments and symptom checking. Fast, accurate, and private.
              </p>
